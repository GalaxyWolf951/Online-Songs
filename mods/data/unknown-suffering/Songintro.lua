    ...
    IntroTagColor = 'F3423D' --Color of the tag at the end of the box.
    ...
    function onCreate()
        ...
        makeLuaText('JukeBoxSubText', 'Unknown Suffering V1', 300, -305-IntroTagWidth, 220)
        ...
        makeLuaText('JukeBoxSubText2', 'Jhaix(Remix By Rhodes_W)', 300, -305-IntroTagWidth, 260)
